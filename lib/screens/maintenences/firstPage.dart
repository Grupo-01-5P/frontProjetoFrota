...
class _ManutencaoScreenState extends State<ManutencaoScreen> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['manutencoes'] is List) {
          ...
          print(
            'Estrutura de resposta da API diferente do esperado: ${data.toString().substring(0, 100)}...',
          );
        }
        ...
        setState(() {
          _errorMessage =
              'Erro ao carregar manutenções: ${response.statusCode}';
          _isLoading = false;
        });
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      // Remova isto se sua tela já está dentro de um MaterialApp
      ...
      home: Scaffold(
        ...
        drawer: CustomDrawer(
          // Função vazia, lógica já implementada no drawer
                        ...
                        onTap: () {
                          ...
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) =>
                                      const ManutencoesSolicitadasScreen(),
                            ),
                          );
                        },
                        child: Card(
                                ...
                                child: Container(
                                  ...
                                  child:
                                      _isLoading
                                          ...
                                          : Text(
                                            _quantidadeManutencoesSolicitadas
                                                .toString(),
                      ...
                      child: InkWell(
                        onTap: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (context) => const ManutencoesGeralScreen(),
                            ),
                          );
                        },
                        child: Card(
    ...
    try {
      return Image.asset(
        ...
        errorBuilder: (context, error, stackTrace) {
          ...
          return Icon(Icons.directions_car, size: width / 2, color: iconColor);
        },
      );
    } catch (e) {
