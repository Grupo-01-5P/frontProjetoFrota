...
class _ManutencaoDetailScreenState extends State<ManutencaoDetailScreen> {
  ...
  // Função para navegar para a tela de fases
  ...
  Future<void> _carregarOficinas() async {
    ...
    try {
      final token = await _secureStorage.read(key: 'auth_token'); // Corrigido para 'token'
  ...
  void _mostrarDialogoSelecionarOficina() {
    ...
    _filtroNome = '';
    _filtroCidade = '';
    _oficinasFiltradas = List.from(_oficinas); // Corrigido
                          ...
                          : ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return ListTile(
                                  ...
                                  onTap: () {
                                    Navigator.of(context).pop();
                                    this.setState(() { // Corrigido para usar this.setState
        ...
        children: [
          SingleChildScrollView(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                // Card de ação rápida para ver fases (se aplicável)
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          if (widget.manutencao['dataEnviarMecanica'] != null)
                            Text(
                              'Data para levar: ${_formatDate(widget.manutencao['dataEnviarMecanica'])}',
                            ),
                        ],
                      ),
                    ),
